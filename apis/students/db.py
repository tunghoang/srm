...
class Student(__db.Base):
  ...
  def json(self):
    return {
      "idStudent":self.idStudent,"studentNumber":self.studentNumber,"email":self.email,"fullname":self.fullname,"dob":str(self.dob),"gender":self.gender,"klass":self.klass,"idKlass":self.idKlass,"mobile":self.mobile,
    }
